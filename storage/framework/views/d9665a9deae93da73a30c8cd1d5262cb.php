...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="/" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('build/images/atslogo.png')); ?>" alt="" height="30">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('build/images/atslogo.png')); ?>" alt="" height="40">
            </span>
        </a>
        <!-- Light Logo-->
               ...
               <!-- delete 
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages">
                        <i class="ri-pages-line"></i><span>Job Manager</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="apps-crm-companies" class="nav-link">Manage Compnay</a>
                            </li>

                        
                            <li class="nav-item">
                                <a href="apps-projects-create" class="nav-link">Add New Job</a>
                            </li>
                            <li class="nav-item">
                                <a href="apps-ecommerce-products" class="nav-link">List All Jobs</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLanding" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLanding">
                        <i class="ri-rocket-line"></i> <span>User Manager</span>

                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLanding">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="forms-layouts" class="nav-link"> Add New User </a>
                            </li>
                            <li class="nav-item">
                                <a href="apps-ecommerce-customers" class="nav-link">List All Users </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUI">
                        <i class="ri-pencil-ruler-2-line"></i> <span>Candidate Manager</span>
                    </a>
                    <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                        <div class="row">
                            <div class="col-lg-4">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="forms-layouts" class="nav-link">Add New Candidate</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="apps-ecommerce-customers" class="nav-link">List All Candidate</a>
                                    </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAdvanceUI">
                        <i class="ri-stack-line"></i> <span>Sales(Comming Soon)</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="pages-coming-soon"  target="_blank" class="nav-link">Comming Soon</a>
                            </li>
...
<?php /**PATH D:\project\laravel\ats-circle\atsCircle\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>