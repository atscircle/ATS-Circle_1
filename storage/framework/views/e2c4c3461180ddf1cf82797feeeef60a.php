                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-xs me-2 flex-shrink-0">
                                                <div class="avatar-title bg-danger-subtle rounded">
                                                    <img src="<?php echo e(URL::asset('build/images/companies/img-4.png')); ?>" alt=""
                                                        height="16">
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card-body text-center">
                            <div class="avatar-md mb-3 mx-auto">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jpg')); ?>" alt="" id="candidate-img"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel\ats-circle\atsCircle\resources\views/dashboard-job.blade.php ENDPATH**/ ?>