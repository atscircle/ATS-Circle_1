                ...
                <div class="card-header">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <span>All Company</span>
                            <button class="btn btn-secondary add-btn float-end" data-bs-toggle="modal" data-bs-target="#showModal"><i
                            ...
                            <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="name" scope="col">Brand name</th>
                                        <th class="sort" data-sort="owner" scope="col">POC</th>
                                        <th class="sort" data-sort="industry_type" scope="col">Mobile</th>
                                        <th class="sort" data-sort="star_value" scope="col">Email</th>
                                        <th class="sort" data-sort="location" scope="col">Status</th>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel\ats-circle\atsCircle\resources\views/apps-crm-companies.blade.php ENDPATH**/ ?>