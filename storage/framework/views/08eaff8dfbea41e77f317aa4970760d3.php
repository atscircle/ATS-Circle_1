            ...
            <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
                <div class="container">
                    <a class="navbar-brand" href="index">
                        <img src="<?php echo e(URL::asset('build/images/atslogo.png')); ?>" class="card-logo card-logo-dark" alt="logo dark"
                            height="50">
                        <img src="<?php echo e(URL::asset('build/images/atslogo.png')); ?>" class="card-logo card-logo-light" alt="logo light"
                            height="50">
                    </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center mt-lg-5 pt-5">
                                <h1 class="display-6 fw-semibold mb-3 lh-base">ATS Circle - Low-Cost – User-Friendly Tool to Simplify
                                    <span class="text-secondary">Your Business! </span></h1>
                                <p class="lead text-muted lh-base">At ATS Circle, we understand that the success of your recruitment relies on finding top talent while managing client relationships efficiently. That's why we've developed a tool that integrates ATS functionalities with Sales CRM.</p>
                            ...
                            <div class="mt-4 mt-sm-5 pt-sm-5 mb-sm-n5 demo-carousel">
                                <div class="demo-img-patten-top d-none d-sm-block">
                                    <img src="<?php echo e(URL::asset('build/images/landing/img-pattern.png')); ?>" class="d-block img-fluid"
                                        alt="...">
                                </div>
                                ...
                                <div class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner shadow-lg p-2 bg-white rounded">
                                        ...
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <img src="<?php echo e(URL::asset('build/images/demos/material.png')); ?>" class="d-block w-100"
                                                alt="...">
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <img src="<?php echo e(URL::asset('build/images/demos/minimal.png')); ?>" class="d-block w-100"
                                                alt="...">
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <img src="<?php echo e(URL::asset('build/images/demos/creative.png')); ?>" class="d-block w-100"
                                                alt="...">
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <img src="<?php echo e(URL::asset('build/images/demos/modern.png')); ?>" class="d-block w-100"
                                                alt="...">
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <img src="<?php echo e(URL::asset('build/images/demos/interactive.png')); ?>" class="d-block w-100"
                                                alt="...">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel\ats-circle\atsCircle\resources\views/landing.blade.php ENDPATH**/ ?>